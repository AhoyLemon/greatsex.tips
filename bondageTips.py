...
bondageTips = [
  ...
  [
    ...
    "show off what you learned in the porno American Horror Story.",
    ...
    "go back to reading Fifty Shades of Grey.",
    ...
    "put on reruns of Bridezillas."
  ]]
bondagetip = choice(bondageTips[0]) + choice(bondageTips[1]) + bondageTips[2] + choice(bondageTips[3]) + bondageTips[4] + choice(bondageTips[5]) + bondageTips[6] + choice(bondageTips[7])
