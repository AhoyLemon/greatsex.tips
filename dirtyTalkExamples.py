...
dirtytalkexamples = [[
  ...
  [
    ...
    "I didn't think it was possible for sex to jump the shark, and yet here we are.",
    ...
    "And they said replacing my vagina with a cantalope would be a bad thing!",
    "A problem has been detected and Windows has been shut down to prevent damage to your computer.",
    "Oh shit, cramp, CRAMP! CRAMP IN MY FOOT!",
    "The end of the Truman Show was kinda bullshit, if you think about it.",
    ...
    "OMG your dick is hilarious! I'm so putting this up on YouTube.",
    "You wouldn't steal a car.",
    "Hey, apropos of nothing, do you feel about the movie Teeth?",
...
dirtytalkexample = random.choice(dirtytalkexamples[0]) + dirtytalkexamples[1] + random.choice(dirtytalkexamples[2]) +  dirtytalkexamples[3] + random.choice(dirtytalkexamples[4]) +  dirtytalkexamples[5] +  random.choice(dirtytalkexamples[6]) + dirtytalkexamples[7] + random.choice(dirtytalkexamples[8])
