...
handjobs = [
  ...
  [
    ...
    "realize that this dick has been dead for six years.",
    ...
    "bury him up to his dick to reenact Dawn of the Dead.",
    "dress it in a glittery outfit for a one woman and dick burlesque performance.",
    "place it in dick prison for the crime of malfeasance in orifice.",
...
handjob = choice(handjobs[0]) + handjobs[1] + choice(handjobs[2])
