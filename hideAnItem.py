...
hideAnItem = [
  ...
  [
    ...
    "sing the Katie Perry\'s Peacock but get the lyrics wrong.",
    "beatbox Paralyzer while stripping.",
...
hideanitem = choice(hideAnItem[0]) + hideAnItem[1] + choice(hideAnItem[2]) + hideAnItem[3] + choice(hideAnItem[4]) + hideAnItem[5] + choice(hideAnItem[6]) + hideAnItem[7] + choice(hideAnItem[8])
